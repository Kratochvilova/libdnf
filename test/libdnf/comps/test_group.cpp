...
void CompsGroupTest::test_load() {
    ...
    std::vector<libdnf::comps::Package> expected_packages_core;
    expected_packages_core.push_back(libdnf::comps::Package("bash", libdnf::comps::MANDATORY, ""));
    expected_packages_core.push_back(libdnf::comps::Package("glibc", libdnf::comps::MANDATORY, ""));
    expected_packages_core.push_back(libdnf::comps::Package("dnf", libdnf::comps::DEFAULT, ""));
    expected_packages_core.push_back(libdnf::comps::Package("conditional", libdnf::comps::CONDITIONAL, "nonexistent"));
    expected_packages_core.push_back(libdnf::comps::Package("dnf-plugins-core", libdnf::comps::OPTIONAL, ""));
    for (unsigned i = 0; i < expected_packages_core.size(); i++) {
        CPPUNIT_ASSERT_EQUAL(expected_packages_core[i].get_name(), core.get_packages()[i].get_name());
        CPPUNIT_ASSERT_EQUAL(expected_packages_core[i].get_type(), core.get_packages()[i].get_type());
        CPPUNIT_ASSERT_EQUAL(expected_packages_core[i].get_condition(), core.get_packages()[i].get_condition());
    }
    ...
    std::vector<libdnf::comps::Package> expected_packages_standard;
    expected_packages_standard.push_back(libdnf::comps::Package("cryptsetup", libdnf::comps::MANDATORY, ""));
    expected_packages_standard.push_back(libdnf::comps::Package("chrony", libdnf::comps::CONDITIONAL, "gnome-control-center"));
    expected_packages_standard.push_back(libdnf::comps::Package("conditional", libdnf::comps::CONDITIONAL, "nonexistent"));
    for (unsigned i = 0; i < expected_packages_standard.size(); i++) {
        CPPUNIT_ASSERT_EQUAL(expected_packages_standard[i].get_name(), standard.get_packages()[i].get_name());
        CPPUNIT_ASSERT_EQUAL(expected_packages_standard[i].get_type(), standard.get_packages()[i].get_type());
        CPPUNIT_ASSERT_EQUAL(expected_packages_standard[i].get_condition(), standard.get_packages()[i].get_condition());
    }
}
...
void CompsGroupTest::test_merge() {
    ...
    std::vector<libdnf::comps::Package> expected_packages_core2;
    expected_packages_core2.push_back(libdnf::comps::Package("bash", libdnf::comps::MANDATORY, ""));
    expected_packages_core2.push_back(libdnf::comps::Package("glibc", libdnf::comps::MANDATORY, ""));
    expected_packages_core2.push_back(libdnf::comps::Package("dnf", libdnf::comps::DEFAULT, ""));
    expected_packages_core2.push_back(libdnf::comps::Package("dnf-plugins-core", libdnf::comps::OPTIONAL, ""));
    for (unsigned i = 0; i < expected_packages_core2.size(); i++) {
        CPPUNIT_ASSERT_EQUAL(expected_packages_core2[i].get_name(), core2.get_packages()[i].get_name());
        CPPUNIT_ASSERT_EQUAL(expected_packages_core2[i].get_type(), core2.get_packages()[i].get_type());
        CPPUNIT_ASSERT_EQUAL(expected_packages_core2[i].get_condition(), core2.get_packages()[i].get_condition());
    }
}
